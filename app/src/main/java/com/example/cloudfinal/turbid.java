...
public class turbid extends AppCompatActivity {
    ...
    // the result from db
    PaginatedList<HackTurbidDO> dbresult;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_turbid);
        ...
        //下拉刷新
        mRefreshLayout = findViewById(R.id.refresh_layout_turbid);
    ...
    Thread query= new Thread(new Runnable() {
        @Override
        public void run() {
            HackTurbidDO hackTurbidDO = new HackTurbidDO();
            hackTurbidDO.setPrimary("p");
            hackTurbidDO.setTimeStamp("2019-01");
            ...
            DynamoDBQueryExpression queryExpression = new DynamoDBQueryExpression()
                    .withHashKeyValues(hackTurbidDO)
                    .withRangeKeyCondition("timeStamp", rangeKeyCondition)
                    .withConsistentRead(false);

            dbresult = dynamoDBMapper.query(HackTurbidDO.class, queryExpression);
    ...
    public void handlejson(PaginatedList<HackTurbidDO> paginatedList){
        ...
        for (int i = 0; i < paginatedList.size(); i++) {
            ...
            try {
                ...
                String turbid = obj.getString("turbid");
                ...
                tmp_array.add(ID);
                tmp_array.add(turbid);
                tmp_array.add(timeStamp);

                rowlist.add(tmp_array);

                //Log.e("My App", obj.toString());
                Log.e("attribute:", "ID is " + ID +", turbid is " + turbid + ", timeStamp is " + timeStamp);
    ...
    public void createTable(){
        // set table
        tab = findViewById(R.id.table_turbid);
